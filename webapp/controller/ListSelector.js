sap.ui.define([
	...
	return BaseObject.extend("sap.espm.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias sap.espm.model.ListSelector
		 */
		 ...
		 * @return {sap.espm.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
